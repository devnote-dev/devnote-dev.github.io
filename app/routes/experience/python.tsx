      ...
      <div className="m-12 font-[Roboto Medium,monospace]">
        ...
        <div className="grid gap-y-4">
          ...
          <p>
            ...
            skills have circulated around my secondary school (not just
            programming). Surprisingly I was respected more because of this, and
            I was often asked to help students and teachers with various
            technical issues which I enjoyed doing. However, I still felt as if
            I was lacking something despite the appraisal. Was it knowledge?
            Experience? Technical comprehension? Simply put: yes; although I
            didn't know it at the time. My focus was on expanding my knowledge
            on operating systems and command line interfaces, but there is only
            so much a poor education system and hours of aimless Googling can
            get you. This continued into the following year to no avail. I was
            burnt out and disappointed, and with exams ever approaching I
            decided to take a break from programming altogether.
          </p>
          <p>
            Well, that's what I thought anyway. Turns out a very problematic
            virus had other ideas and decided to uproot everything, so I was
            ...
            Needless to say I was startled by the incident which put me off
            doing anything with the bot for a while, but I eventually returned
            to the Discord space for round 2 which didn't dramatically fail
            without warning.
          </p>
          <p>
            As time <em>slowly</em> passed (like extremely slowly), I continued
            to develop my skills with Discord bots. I was also able to thrive in
            a great Discord community where I learned a lot of the programming
